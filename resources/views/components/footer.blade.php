    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 col-md-2 mb-3 custom-section">
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="/" class="nav-link p-0 text-body-secondary nav-link-custom"><H6>TMCAPACITACIÓN</H6></a></li>
                            <li class="nav-item mb-2"><a href="/cursos" class="nav-link p-0 text-body-secondary nav-link-custom"><H6>AULA VIRTUAL</H6></a></li>
                            <li class="nav-item mb-2"><a href="/contacto" class="nav-link p-0 text-body-secondary nav-link-custom"><H6>CONTACTO</H6></a></li>
                            <li class="nav-item mb-2"><a href="/nosotros" class="nav-link p-0 text-body-secondary nav-link-custom"><H6>NOSOTROS</H6></a></li>
                        </ul>
                </div>
